...
export default function PropertyAsociado() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-white to-emerald-50/30 pb-24">
      <Header />
        ...
        <div className="space-y-4 mb-8">
          <div className="p-6 bg-white border border-border rounded-2xl shadow-sm">
            <div className="flex items-start gap-4">
              <Building className="w-6 h-6 text-emerald-500 flex-shrink-0 mt-1" />
              <div>
          ...
          <div className="p-6 bg-white border border-border rounded-2xl shadow-sm">
            <div className="flex items-start gap-4">
              <Percent className="w-6 h-6 text-emerald-500 flex-shrink-0 mt-1" />
              <div>
