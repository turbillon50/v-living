    ...
    <div className="min-h-screen bg-white pb-60">
      ...
      <div className="px-5 pt-6">
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            <h1 className="text-2xl font-bold text-[#222]" style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", fontWeight: 300 }} data-testid="heading-chofer">Choferes Privados</h1>
            <p className="text-[#717171]">Transporte ejecutivo y discreto</p>
          </div>
        </div>
        ...
        <div className="bg-[#f7f7f7] rounded-md p-5 mb-6 border border-[#ebebeb]">
          <div className="flex items-center gap-2 mb-3">
            ...
            <h2 className="font-bold text-[#222]" style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", fontWeight: 400 }} data-testid="heading-beneficio-chofer">Tu Beneficio Fractional Living</h2>
          </div>
        ...
        <div className="bg-[#f7f7f7] rounded-md p-5 mb-6 border border-[#ebebeb]">
          ...
          <p className="text-[#717171] text-sm leading-relaxed mb-4">
            En <strong className="text-[#222]">All Global Holding</strong> entendemos que tu 
        ...
        <div className="bg-[#f7f7f7] rounded-md p-5 mb-6 border border-[#ebebeb]">
          ...
          <div className="space-y-3">
            <div className="bg-white rounded-md p-3 border border-[#ebebeb]">
              <p className="font-semibold text-sm text-[#222]">Traslado Aeropuerto</p>
              <p className="text-xs text-[#888]">CUN - Tu propiedad • Ida y vuelta</p>
            </div>
            <div className="bg-white rounded-md p-3 border border-[#ebebeb]">
              <p className="font-semibold text-sm text-[#222]">Servicio Por Hora</p>
