  ...
  return (
    <div className="min-h-screen bg-white pt-14">
        ...
        <div className="relative h-[420px] md:h-[500px]">
          ...
          <div className="relative z-10 flex flex-col items-center justify-center h-full px-6 text-center pt-16">
            <div className="fl-fade-in">
              ...
              <h1 className="text-4xl md:text-5xl text-[#222] tracking-wide mb-3" style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", fontWeight: 300 }} data-testid="hero-title-lmc">
                Last Minute Capital
              </h1>
      ...
      <main className="max-w-4xl mx-auto px-6 -mt-8 relative z-20">
        <div className="bg-white border border-[#ebebeb] rounded-2xl shadow-sm p-6 md:p-8 mb-8" data-testid="card-lmc-intro">
          ...
          <p className="text-[#999] text-sm mt-4 italic">
        ...
        <section className="mb-10">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div className="bg-gradient-to-br from-[#059669] to-[#06b6d4] rounded-2xl p-6 text-white" data-testid="card-lmc-returns">
            ...
            <div className="bg-[#f7f7f7] border border-[#ebebeb] rounded-2xl p-6" data-testid="card-lmc-amounts">
        ...
        <section className="bg-gradient-to-br from-[#059669] to-[#06b6d4] rounded-2xl p-8 text-center mb-10" data-testid="card-lmc-synthesis">
        ...
        <div className="text-center mb-16">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            ...
            <Link href="/">
              <span className="inline-flex items-center justify-center gap-2 px-8 py-3 border border-[#ebebeb] text-[#717171] text-sm font-medium rounded-xl hover:bg-[#f7f7f7] transition-all cursor-pointer" data-testid="button-back-lmc">
