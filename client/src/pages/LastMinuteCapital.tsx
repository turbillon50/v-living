  ...
  return (
    <div className="min-h-screen bg-[#030810] pt-14">
        ...
        <div className="relative h-[420px] md:h-[500px]">
          ...
          <div className="relative z-10 flex flex-col items-center justify-center h-full px-6 text-center pt-16">
            <div className="fl-fade-in">
              ...
              <p className="text-[#e2e8f0] max-w-lg mx-auto font-light text-sm md:text-base">
                {language === 'es'
      ...
      <main className="max-w-4xl mx-auto px-6 -mt-8 relative z-20">
        <div className="fl-glass-card p-6 md:p-8 mb-8" data-testid="card-lmc-intro">
        ...
        <section className="mb-10">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <div className="bg-gradient-to-br from-[#030810] to-[#1e293b] rounded-2xl p-6 text-white border border-[rgba(6,182,212,0.12)]" data-testid="card-lmc-amounts">
        ...
        <section className="mb-10">
          ...
          <div className="fl-glass-card p-5">
            <div className="flex items-start gap-3">
              <div className="w-10 h-10 rounded-lg bg-[rgba(6,182,212,0.06)] border border-[rgba(6,182,212,0.08)] flex items-center justify-center flex-shrink-0">
        ...
        <section className="bg-gradient-to-br from-[#030810] to-[#0e7490] rounded-2xl p-8 text-center mb-10 border border-[rgba(6,182,212,0.12)]" data-testid="card-lmc-synthesis">
        ...
        <div className="text-center mb-16">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            ...
            <Link href="/">
              <span className="inline-flex items-center justify-center gap-2 px-8 py-3 border border-[rgba(6,182,212,0.12)] text-[#64748b] text-sm font-medium rounded-xl hover:bg-white/5 transition-all cursor-pointer" data-testid="button-back-lmc">
