  ...
  return (
    <div className="min-h-screen bg-[#030810] pt-14">
      ...
      <main className="max-w-4xl mx-auto px-6 -mt-8 relative z-20">
        <div className="fl-glass-card p-6 md:p-8 mb-8" data-testid="card-modelo-intro">
          <p className="text-[#64748b] leading-relaxed mb-4 text-lg italic text-center" style={{ fontFamily: "'Cormorant Garamond', Georgia, serif" }}>
          ...
          <div className="bg-[rgba(6,182,212,0.06)] border border-[rgba(6,182,212,0.12)] rounded-xl p-4">
        ...
        <section className="mb-8">
          ...
          <div className="fl-glass-card p-4">
            <p className="text-white font-medium mb-1 text-sm">{language === 'es' ? 'Entendimos algo fundamental:' : 'We understood something fundamental:'}</p>
            <p className="text-[#64748b] text-sm">{language === 'es' ? 'Los activos ya no se venden igual, y quien no se adapta, desaparece.' : 'Assets no longer sell the same way, and those who don\'t adapt, disappear.'}</p>
          </div>
          <p className="text-[#94a3b8] text-sm italic text-center mt-4">
            {language === 'es' ? 'La respuesta era ' : 'The answer was '}<span className="text-[#22d3ee] font-medium">{language === 'es' ? 'reconfigurar el modelo' : 'reconfigure the model'}</span>.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <div className="bg-[rgba(6,182,212,0.06)] border border-[rgba(6,182,212,0.12)] rounded-xl p-4 mb-4 text-center">
            <p className="text-[#22d3ee] text-sm italic" style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", fontSize: '1rem' }}>
              {language === 'es'
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="fl-glass-card p-3 text-center">
              <p className="text-[#22d3ee] text-sm font-medium">{language === 'es' ? 'Dividir la propiedad' : 'Divide property'}</p>
              <p className="text-[#94a3b8] text-xs">{language === 'es' ? 'no el valor' : 'not value'}</p>
            </div>
            <div className="fl-glass-card p-3 text-center">
              <p className="text-[#22d3ee] text-sm font-medium">{language === 'es' ? 'Multiplicar los puntos de entrada' : 'Multiply entry points'}</p>
        ...
        <section className="mb-8">
          ...
          <div className="grid grid-cols-2 gap-3">
            {[
              ...
              <div key={i} className="flex items-center gap-2 bg-[rgba(6,182,212,0.06)] rounded-lg p-3">
        ...
        <section className="mb-8">
          ...
          <div className="bg-[rgba(6,182,212,0.06)] border border-[rgba(6,182,212,0.12)] rounded-xl p-4 mb-4 text-center">
            <p className="text-[#22d3ee] font-medium text-sm">{language === 'es' ? 'La digitalización no es el negocio. Es el vehículo.' : 'Digitization is not the business. It is the vehicle.'}</p>
          </div>
          <div className="grid md:grid-cols-2 gap-4 mb-4">
            <div className="fl-glass-card p-4">
              <p className="text-white font-medium mb-1 text-sm">Security Tokens</p>
            ...
            <div className="fl-glass-card p-4">
              <p className="text-white font-medium mb-1 text-sm">Utility Tokens</p>
        ...
        <section className="mb-8">
          ...
          <p className="text-[#64748b] text-center italic mb-6 text-sm">
            {language === 'es' ? 'Cada pieza cumple una función clara:' : 'Each piece fulfills a clear function:'}
          </p>

          <div className="space-y-4">
            {operativeSteps.map((step) => (
              <div key={step.num} className="bg-[rgba(6,182,212,0.04)] border border-[rgba(6,182,212,0.08)] rounded-xl p-4 border-l-4 border-l-[#0891b2]">
          ...
          <p className="text-[#22d3ee] font-medium text-center mt-6" style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", fontSize: '1.1rem' }}>
        ...
        <section className="mb-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-3 mb-6">
            {['Capital', language === 'es' ? 'Crédito' : 'Credit', language === 'es' ? 'Tiempo' : 'Time', language === 'es' ? 'Uso' : 'Use', language === 'es' ? 'Estructura' : 'Structure', language === 'es' ? 'Tecnología' : 'Technology'].map((item, i) => (
              <div key={i} className="bg-[rgba(6,182,212,0.06)] rounded-lg p-3 text-center">
                <p className="text-[#22d3ee] text-sm font-medium">{item}</p>
              </div>
            ))}
          </div>
          <div className="grid md:grid-cols-2 gap-3">
            {[
              ...
              <div key={i} className="flex items-center gap-2 bg-[rgba(6,182,212,0.04)] border border-[rgba(6,182,212,0.08)] rounded-lg p-3 shadow-sm">
                <div className="w-5 h-5 rounded-full bg-gradient-to-br from-[#0891b2] to-[#22d3ee] flex items-center justify-center flex-shrink-0">
        ...
        <section className="bg-gradient-to-br from-[#030810] to-[#0e7490] rounded-2xl p-8 text-center mb-10" data-testid="card-modelo-cierre">
        ...
        <div className="text-center mb-16">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            ...
            <Link href="/">
              <span className="inline-flex items-center justify-center gap-2 px-8 py-3 border border-[rgba(6,182,212,0.12)] text-[#64748b] text-sm font-medium rounded-xl hover:bg-white/5 transition-all cursor-pointer" data-testid="button-back-modelo">
