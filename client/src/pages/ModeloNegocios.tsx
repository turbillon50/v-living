  ...
  return (
    <div className="min-h-screen bg-white pt-14">
          ...
          <div className="relative z-10 flex flex-col items-center justify-center h-full px-6 text-center pt-16">
            <div className="fl-fade-in">
              <div className="flex justify-center mb-5">
                <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-[#059669] to-[#06b6d4] flex items-center justify-center shadow-lg shadow-[#059669]/30">
              ...
              <h1 className="text-4xl md:text-5xl text-[#222] tracking-wide mb-3" style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", fontWeight: 300 }} data-testid="hero-title-modelo">
                {language === 'es' ? 'Modelo de Negocio' : 'Business Model'}
              </h1>
              <p className="text-[#555] max-w-lg mx-auto font-light text-sm md:text-base">
                {language === 'es'
      ...
      <main className="max-w-4xl mx-auto px-6 -mt-8 relative z-20">
        <div className="bg-white border border-[#ebebeb] rounded-2xl shadow-sm p-6 md:p-8 mb-8" data-testid="card-modelo-intro">
          <p className="text-[#717171] leading-relaxed mb-4 text-lg italic text-center" style={{ fontFamily: "'Cormorant Garamond', Georgia, serif" }}>
          ...
          <p className="text-[#717171] leading-relaxed mb-4 text-sm">
            {language === 'es'
              ? 'All Global Holding LLC is a Limited Liability Company constituida en Estados Unidos, creada para diseñar, estructurar y operar modelos de capital vinculados a activos reales.'
          ...
          <div className="bg-[#f0fdf4] border border-[#059669]/15 rounded-xl p-4">
        ...
        <section className="mb-8">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-[#059669] to-[#06b6d4] flex items-center justify-center">
              <svg className="w-5 h-5 text-white" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
                <polyline points="23 6 13.5 15.5 8.5 10.5 1 18" /><polyline points="17 6 23 6 23 12" />
              </svg>
            </div>
            <h2 className="text-2xl text-[#222]" style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", fontWeight: 400 }}>
              {language === 'es' ? 'Momento de adaptación' : 'Moment of Adaptation'}
            </h2>
          </div>
          <p className="text-[#717171] leading-relaxed text-sm mb-4">
            {language === 'es'
          ...
          <div className="bg-white border border-[#ebebeb] rounded-2xl shadow-sm p-4">
            <p className="text-[#222] font-medium mb-1 text-sm">{language === 'es' ? 'Entendimos algo fundamental:' : 'We understood something fundamental:'}</p>
            <p className="text-[#717171] text-sm">{language === 'es' ? 'Los activos ya no se venden igual, y quien no se adapta, desaparece.' : 'Assets no longer sell the same way, and those who don\'t adapt, disappear.'}</p>
          </div>
          <p className="text-[#717171] text-sm italic text-center mt-4">
            {language === 'es' ? 'La respuesta era ' : 'The answer was '}<span className="text-[#059669] font-medium">{language === 'es' ? 'reconfigurar el modelo' : 'reconfigure the model'}</span>.
          </p>
        </section>
        ...
        <section className="mb-8">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              ...
              <p className="text-[#717171] text-xs">({language === 'es' ? 'y lo que NO es' : 'and what it is NOT'})</p>
            </div>
          </div>
          <p className="text-[#717171] leading-relaxed text-sm mb-4">
            {language === 'es'
          ...
          <div className="bg-[#f0fdf4] border border-[#059669]/15 rounded-xl p-4 mb-4 text-center">
            <p className="text-[#059669] text-sm italic" style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", fontSize: '1rem' }}>
              {language === 'es'
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="bg-white border border-[#ebebeb] rounded-2xl shadow-sm p-3 text-center">
              <p className="text-[#059669] text-sm font-medium">{language === 'es' ? 'Dividir la propiedad' : 'Divide property'}</p>
              <p className="text-[#717171] text-xs">{language === 'es' ? 'no el valor' : 'not value'}</p>
            </div>
            <div className="bg-white border border-[#ebebeb] rounded-2xl shadow-sm p-3 text-center">
              <p className="text-[#059669] text-sm font-medium">{language === 'es' ? 'Multiplicar los puntos de entrada' : 'Multiply entry points'}</p>
              <p className="text-[#717171] text-xs">{language === 'es' ? 'no reducir la calidad' : 'not reduce quality'}</p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-8">
          ...
          <div className="grid grid-cols-2 gap-3">
            {[
              ...
              <div key={i} className="flex items-center gap-2 bg-[#f0fdf4] rounded-lg p-3">
                <div className="w-5 h-5 rounded-full bg-gradient-to-br from-[#059669] to-[#06b6d4] flex items-center justify-center flex-shrink-0">
                  <svg className="w-3 h-3 text-white" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round">
                    <polyline points="20 6 9 17 4 12" />
                  </svg>
                </div>
                <span className="text-[#717171] text-sm">{item}</span>
              </div>
            ))}
          </div>
        </section>
        ...
        <section className="mb-8">
          ...
          <div className="bg-[#f0fdf4] border border-[#059669]/15 rounded-xl p-4 mb-4 text-center">
            <p className="text-[#059669] font-medium text-sm">{language === 'es' ? 'La digitalización no es el negocio. Es el vehículo.' : 'Digitization is not the business. It is the vehicle.'}</p>
          </div>
          <div className="grid md:grid-cols-2 gap-4 mb-4">
            <div className="bg-white border border-[#ebebeb] rounded-2xl shadow-sm p-4">
              <p className="text-[#222] font-medium mb-1 text-sm">Security Tokens</p>
              <p className="text-[#717171] text-xs">{language === 'es' ? 'Vinculados a activos reales y estructuras específicas' : 'Linked to real assets and specific structures'}</p>
            </div>
            <div className="bg-white border border-[#ebebeb] rounded-2xl shadow-sm p-4">
              <p className="text-[#222] font-medium mb-1 text-sm">Utility Tokens</p>
              <p className="text-[#717171] text-xs">{language === 'es' ? 'Diseñados para acceso, uso y operación' : 'Designed for access, use and operation'}</p>
            </div>
          </div>
          <div className="flex flex-wrap gap-2 justify-center">
            <span className="px-3 py-1 bg-gradient-to-r from-[#059669] to-[#06b6d4] text-white rounded-full text-xs">Token ALIX</span>
            <span className="px-3 py-1 bg-gradient-to-r from-[#059669] to-[#06b6d4] text-white rounded-full text-xs">Token LNC</span>
            <span className="px-3 py-1 bg-gradient-to-r from-[#059669] to-[#06b6d4] text-white rounded-full text-xs">ALIX (IA operativa)</span>
          </div>
        </section>
        ...
        <section className="mb-8">
          ...
          <div className="bg-gradient-to-br from-[#059669] to-[#047857] rounded-xl p-4 text-center">
        ...
        <section className="mb-8">
          ...
          <p className="text-[#717171] text-center italic mb-6 text-sm">
            {language === 'es' ? 'Cada pieza cumple una función clara:' : 'Each piece fulfills a clear function:'}
          </p>

          <div className="space-y-4">
            {operativeSteps.map((step) => (
              <div key={step.num} className="bg-[#f0fdf4] border border-[#059669]/10 rounded-xl p-4 border-l-4 border-l-[#059669]">
                <div className="flex items-center gap-3 mb-2">
                  <span className="w-8 h-8 bg-gradient-to-br from-[#059669] to-[#06b6d4] rounded-full flex items-center justify-center text-white font-bold text-sm flex-shrink-0">
                    {step.num}
                  </span>
                  <p className="text-[#222] font-medium text-sm">{step.title}</p>
                </div>
                <p className="text-[#717171] text-sm pl-11">{step.desc}</p>
              </div>
            ))}
          </div>
          <p className="text-[#059669] font-medium text-center mt-6" style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", fontSize: '1.1rem' }}>
            {language === 'es' ? 'Nada compite. Todo suma.' : 'Nothing competes. Everything adds up.'}
          </p>
        </section>

        <section className="mb-8">
          <h2 className="text-2xl text-[#222] text-center mb-6" style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", fontWeight: 400 }}>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-3 mb-6">
            {['Capital', language === 'es' ? 'Crédito' : 'Credit', language === 'es' ? 'Tiempo' : 'Time', language === 'es' ? 'Uso' : 'Use', language === 'es' ? 'Estructura' : 'Structure', language === 'es' ? 'Tecnología' : 'Technology'].map((item, i) => (
              <div key={i} className="bg-[#f0fdf4] rounded-lg p-3 text-center">
                <p className="text-[#059669] text-sm font-medium">{item}</p>
              </div>
            ))}
          </div>
          <div className="grid md:grid-cols-2 gap-3">
            {[
              ...
              <div key={i} className="flex items-center gap-2 bg-[#f0fdf4] border border-[#059669]/10 rounded-lg p-3 shadow-sm">
                <div className="w-5 h-5 rounded-full bg-gradient-to-br from-[#059669] to-[#06b6d4] flex items-center justify-center flex-shrink-0">
        ...
        <section className="bg-gradient-to-br from-[#059669] to-[#06b6d4] rounded-2xl p-8 text-center mb-10" data-testid="card-modelo-cierre">
        ...
        <div className="text-center mb-16">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <a
              ...
              className="inline-flex items-center justify-center gap-2 px-8 py-3 bg-gradient-to-r from-[#059669] to-[#06b6d4] text-white text-sm font-medium rounded-xl hover:shadow-lg hover:shadow-[#059669]/25 transition-all"
              data-testid="cta-whatsapp-modelo"
            >
              {language === 'es' ? 'Contactar Asesor' : 'Contact Advisor'}
            </a>
            <Link href="/">
              <span className="inline-flex items-center justify-center gap-2 px-8 py-3 border border-[#059669]/15 text-[#717171] text-sm font-medium rounded-xl hover:bg-[#f7f7f7] transition-all cursor-pointer" data-testid="button-back-modelo">
