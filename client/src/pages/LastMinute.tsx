  ...
  return (
    <div className="min-h-screen bg-white pt-14">
        ...
        <div className="relative h-[420px] md:h-[500px]">
          ...
          <div className="relative z-10 flex flex-col items-center justify-center h-full px-6 text-center pt-16">
            <div className="fl-fade-in">
              ...
              <h1 className="text-4xl md:text-5xl text-[#222] tracking-wide mb-3" style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", fontWeight: 300 }} data-testid="hero-title-lastminute">
                Last Minute Capital
              </h1>
              ...
              <div className="flex items-center justify-center gap-6 mt-6">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[#717171] text-xs">7%-12% {language === 'es' ? 'rendimiento' : 'returns'}</span>
                </div>
                <div className="flex items-center gap-2">
                  <div className="w-2 h-2 rounded-full bg-[#06b6d4]" />
                  <span className="text-[#717171] text-xs">$20K-$100K MXN</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <main className="max-w-4xl mx-auto px-6 -mt-8 relative z-20">
        <div className="bg-white border border-[#ebebeb] rounded-2xl shadow-sm p-6 md:p-8 mb-8" data-testid="card-intro">
          <p className="text-[#717171] leading-relaxed text-sm md:text-base">
            {language === 'es'
          ...
          <p className="text-[#999] text-sm mt-3 italic">
        ...
        <section className="mb-10">
          ...
          <p className="text-[#717171] leading-relaxed text-sm mt-3">
            {language === 'es'
        ...
        <section className="mb-10">
          ...
          <div className="mt-4 bg-[#f0fdf4] border border-[#059669]/15 rounded-xl p-4">
        ...
        <section className="mb-10">
          <h2 className="text-2xl text-[#222] mb-6" style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", fontWeight: 400 }}>
            {language === 'es' ? 'Propuesta de Valor' : 'Value Proposition'}
          </h2>
          <div className="grid md:grid-cols-2 gap-4">
            <div className="bg-gradient-to-br from-[#059669] to-[#06b6d4] rounded-2xl p-6 text-white" data-testid="card-returns">
            ...
            <div className="bg-[#f7f7f7] border border-[#ebebeb] rounded-2xl p-6" data-testid="card-amounts">
              <p className="text-3xl font-light text-[#222] mb-1" style={{ fontFamily: "'Cormorant Garamond', Georgia, serif" }}>$20K - $100K</p>
              <p className="text-[#717171] text-sm">{language === 'es' ? 'Montos de participación en MXN' : 'Participation amounts in MXN'}</p>
              <p className="text-[#999] text-xs mt-1">{language === 'es' ? 'Integración ágil e inmediata' : 'Agile and immediate integration'}</p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <p className="text-[#717171] leading-relaxed text-sm md:text-base mb-4">
            {language === 'es'
          ...
          <div className="bg-white border border-[#ebebeb] rounded-2xl shadow-sm p-5">
            <div className="flex items-start gap-3">
              <div className="w-10 h-10 rounded-lg bg-[#f0fdf4] border border-[#059669]/10 flex items-center justify-center flex-shrink-0">
              ...
              <div>
                <p className="text-[#222] font-medium text-sm">All Global Holding LLC</p>
                <p className="text-[#717171] text-xs mt-1">
                  {language === 'es'
          ...
          <div className="space-y-3">
            {[
              ...
              <div key={i} className="flex items-start gap-3">
                <div className="w-5 h-5 rounded-full bg-gradient-to-br from-[#059669] to-[#06b6d4] flex items-center justify-center flex-shrink-0 mt-0.5">
                  <svg className="w-3 h-3 text-white" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round">
                    <polyline points="20 6 9 17 4 12" />
                  </svg>
                </div>
                <p className="text-[#717171] text-sm">{item}</p>
              </div>
            ))}
          </div>
          <p className="text-[#717171] text-sm mt-4 italic">
            {language === 'es'
        ...
        <section className="bg-gradient-to-br from-[#059669] to-[#06b6d4] rounded-2xl p-8 text-center mb-10" data-testid="card-synthesis">
          ...
          <div className="space-y-2 text-white/90 italic font-light">
        ...
        <div className="text-center mb-16">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            ...
            <Link href="/">
              <span className="inline-flex items-center justify-center gap-2 px-8 py-3 border border-[#ebebeb] text-[#717171] text-sm font-medium rounded-xl hover:bg-[#f7f7f7] transition-all cursor-pointer" data-testid="button-back-lastminute">
