  ...
  return (
    <div className="min-h-screen bg-white pt-14">
        ...
        <div className="relative h-[420px] md:h-[500px]">
          ...
          <div className="relative z-10 flex flex-col items-center justify-center h-full px-6 text-center pt-16">
            <div className="fl-fade-in">
              ...
              <h1 className="text-4xl md:text-5xl text-[#222] tracking-wide mb-3" style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", fontWeight: 300 }} data-testid="hero-title-asociado">
                {language === 'es' ? 'Perfil Asociado' : 'Associate Profile'}
              </h1>
              <p className="text-[#717171] max-w-lg mx-auto font-light text-sm md:text-base">
                {language === 'es'
      ...
      <main className="max-w-4xl mx-auto px-6 -mt-8 relative z-20">
        <div className="bg-white border border-[#ebebeb] rounded-2xl shadow-sm p-6 md:p-8 mb-8" data-testid="card-asociado-intro">
        ...
        <div className="bg-gradient-to-br from-[#059669] to-[#047857] rounded-2xl p-6 md:p-8 mb-6 text-white" data-testid="card-credito">
        ...
        <div className="bg-[#f7f7f7] border border-[#ebebeb] rounded-2xl p-6 md:p-8 mb-8" data-testid="card-propietario">
          <div className="flex items-center gap-4 mb-6">
            <div className="w-14 h-14 rounded-xl bg-[#f0f0f0] flex items-center justify-center">
              <svg className="w-7 h-7 text-[#059669]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
          ...
          <div className="bg-[#f0f0f0] rounded-xl p-5 mb-6">
            <h3 className="text-[#222] font-medium mb-4 text-sm">
              {language === 'es' ? '¿Qué obtiene el Propietario Asociado?' : 'What does the Owner Associate get?'}
            </h3>
            <div className="space-y-3">
              <div className="flex items-center gap-3">
                <div className="w-5 h-5 rounded-full bg-[#059669]/30 flex items-center justify-center flex-shrink-0">
                  <svg className="w-3 h-3 text-[#059669]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round">
                    <polyline points="20 6 9 17 4 12" />
                  </svg>
                </div>
                <span className="text-[#444] text-sm">
                  {language === 'es' ? 'Venta en plazo' : 'Sale within'} <span className="text-[#222] font-bold">{language === 'es' ? 'no mayor a 12 meses' : 'no more than 12 months'}</span>
                </span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-5 h-5 rounded-full bg-[#059669]/30 flex items-center justify-center flex-shrink-0">
                ...
                <span className="text-[#444] text-sm">
                  <span className="text-[#059669] font-bold text-lg">7% - 12%</span> {language === 'es' ? 'por encima del valor comercial' : 'above commercial value'}
                </span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-5 h-5 rounded-full bg-[#059669]/30 flex items-center justify-center flex-shrink-0">
                ...
                <span className="text-[#444] text-sm">{language === 'es' ? 'Proceso ordenado, transparente y contractual' : 'Organized, transparent and contractual process'}</span>
              </div>
            </div>
          </div>

          <div className="bg-[#f7f7f7] border border-[#ebebeb] rounded-xl p-5 mb-6">
            <h3 className="text-[#444] font-medium mb-2 text-sm">{language === 'es' ? 'Ejemplo práctico:' : 'Practical example:'}</h3>
          ...
          <div className="grid grid-cols-2 gap-3">
            {[
              ...
              <div key={i} className="flex items-start gap-2 bg-[#f7f7f7] border border-[#ebebeb] rounded-lg p-3">
                <div className="w-4 h-4 rounded-full bg-[#059669]/30 flex items-center justify-center flex-shrink-0 mt-0.5">
                  <svg className="w-2.5 h-2.5 text-[#059669]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round">
                    <polyline points="20 6 9 17 4 12" />
                  </svg>
                </div>
        ...
        <div className="bg-white border border-[#ebebeb] rounded-2xl shadow-sm p-6 md:p-8 mb-8">
          ...
          <p className="text-center text-[#717171] mb-6 italic">
            {language === 'es'
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-3 mb-6">
            {[
              ...
              <div key={i} className="bg-[#f0fdf4] border border-[#059669]/10 rounded-lg p-3 text-center">
                <p className="text-[#059669] text-sm font-medium">{item.label}</p>
                <p className="text-[#717171] text-xs">{item.sub}</p>
              </div>
            ))}
          </div>
        ...
        <section className="bg-gradient-to-br from-[#059669] to-[#06b6d4] rounded-2xl p-8 text-center mb-10" data-testid="card-asociado-synthesis">
        ...
        <div className="text-center mb-16">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            ...
            <Link href="/">
              <span className="inline-flex items-center justify-center gap-2 px-8 py-3 border border-[#059669]/15 text-[#717171] text-sm font-medium rounded-xl hover:bg-[#f7f7f7] transition-all cursor-pointer" data-testid="button-back-asociado">
